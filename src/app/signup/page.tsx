...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        toast({
          title: "Η εγγραφή ήταν επιτυχής",
          description: "Παρακαλώ συνδεθείτε με τα στοιχεία σας",
        });
        router.push("/login");
      } else {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({
        title: "Σφάλμα",
        description: "Κάτι πήγε στραβά με τη σύνδεση Google.",
        variant: "destructive",
      });
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Ξεκινήστε δωρεάν με το BidRoom GR</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="organizationName">Όνομα Εταιρείας/Οργανισμού</Label>
              <Input
                id="organizationName"
                type="text"
                placeholder="ACME Α.Ε."
