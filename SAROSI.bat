@echo off
REM ===========================================================================
REM  SAROSI - Real Estate Opportunity Scanner  (Windows launcher)
REM
...
echo ===========================================================================
echo   Real Estate Opportunity Scanner
echo ===========================================================================
echo.
...
%PY% -m akinita.screener --sources csv --csv-path akinita.csv --all-types ^
...
echo.
%PY% -m akinita.screener --sources spitogatos --all-types %BASISFLAG% ^
